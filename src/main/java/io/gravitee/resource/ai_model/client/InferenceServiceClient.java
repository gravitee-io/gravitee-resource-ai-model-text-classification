...
public class InferenceServiceClient {
    ...
    public InferenceServiceClient(Vertx vertx) throws Exception {
        this.vertx = vertx;
        InferenceService inferenceService = new InferenceService(vertx);
    ...
    private InferenceRequest startModel(Map<ModelFileType, String> modelFiles) {
        log.info("Starting model with files:{}", modelFiles);
